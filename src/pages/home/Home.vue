...
<template>
    <div class="fondo w-full max-w-screen">
        <div class="seccion1 h-full">
            ...
            <div class="pl-14 max-[700px]:pl-6 pt-10 max-[700px]:pt-8 text-amarillo font-bold text-3xl" style="grid-area: logo">
    ...
    <div class="seccion2 h-full w-full max-w-screen">
        ...
        <div style="grid-area: video" class="bg-gray-800 flex justify-center items-center aspect-video"><CirclePlay class="text-white h-30 w-auto"/></div>
        <div style="grid-area: texto" class="max-[700px]:hidden bg-[url('/texturas/color/amarillo03.jpg')] flex flex-col justify-center items-start gap-5 p-5 text-xl ">
